...
import { sendTelegramMessage, telegramMessageInputSchema } from "@carbanoid-org/sendkit-core";
...
export default {
  port,
  fetch: (req: Request) => {
    // custom fetch function that ensures the protocol remains https not http
