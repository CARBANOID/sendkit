...
import { sendTelegramMessage } from "@carbanoid-org/sendkit-core";
import z from "zod";
...
program
  ...
  .action(async (chatId: string, message: string) => {
    // argument (chatId: string, message: string) are extracted in order of their defination // their variable name does not matter
